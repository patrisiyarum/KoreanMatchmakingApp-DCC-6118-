      ...
      {isTranslatorOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-white rounded-t-3xl sm:rounded-3xl w-full max-w-2xl flex flex-col shadow-2xl"
          >
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full h-40 px-4 py-3 rounded-lg border border-neutral-300 focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"
                  />
                </div>
                ...
                <div>
                  ...
                  <div className="w-full h-40 px-4 py-3 rounded-lg border border-neutral-200 bg-neutral-50 overflow-y-auto">
                    {outputText || (
              ...
              <button
                ...
                className="w-full bg-blue-600 text-white py-4 rounded-lg font-medium hover:bg-blue-700 disabled:bg-neutral-300 disabled:cursor-not-allowed transition-colors"
              >
                {t('Translate', '번역하기')}
              </button>
